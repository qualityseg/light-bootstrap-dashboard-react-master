              ...
              <Card.Body className="table-full-width table-responsive px-0">
                <Table className="table-hover">
                  ...
                  <tr>
                    ...
                    <td><button onclick="Copiar LinkToClipboard('https://forms.zohopublic.com/juliana15/form/CadastrodeAlunoCursoEAD/formperma/0r9PO01dGPIIQpcEIPEJG6go2MUkIL-c9MfuG71SZ-4')">Copiar Link</button></td>
                  </tr>
                  <tr>
                    ...
                    <td><button onclick="Copiar LinkToClipboard('https://forms.zohopublic.com/vendas61/form/ChecklistdeusodoVeculo/formperma/5uO3SKXxMOdu5iaMPwenTrmiEIXDq3l94YFDj03gNAA')">Copiar Link</button></td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td><button onclick="Copiar LinkToClipboard('https://forms.zohopublic.com/juliana15/form/ComercialQualitySegEngenhariadeSeguranaeMedicinado/formperma/iKxe7-5DD6rWrFM_duryGABo0x1oPTqqlnpafECN11w')">Copiar Link</button></td>
                  </tr>
                  <tr>
                    ...
                    <td><button onclick="Copiar LinkToClipboard('https://forms.zohopublic.com/vendas61/form/PREENCHIMENTOCHECKLISTPARAABERTURADECATS2210/formperma/G-YBBYanBv3bWzUDeCWveTNYVBWSqCeILuISBllwQOE')">Copiar Link</button></td>
                  </tr>
                  <tr>
                    ...
                    <td><button onclick="Copiar LinkToClipboard('https://forms.zohopublic.com/vendas61/form/DadosparaelaboraodosprogramasPRGPCMSO/formperma/24-A-_EX6D2TSTbuLRlJUv6AYv6VQHVTlSaDO2ESPrw')">Copiar Link</button></td>
                  </tr>
                  <tr>
                    ...
                    <td><button onclick="Copiar LinkToClipboard('https://forms.zohopublic.com/esocial/form/EnviodoESocial/formperma/FuLjyXmuFRHA9dcUFtBFaXAlTkpSTmUW6AJiuI8c9mc')">Copiar Link</button></td>
                  </tr>
                  <tr>
                    ...
                    <td><button onclick="Copiar LinkToClipboard('https://forms.zohopublic.com/juliana15/form/PPPPerfilProfissiogrficoPrevidencirio/formperma/hm4WW-EyrnN31vW7pD1xOheJkBnz36rN15rYgSR_4-0')">Copiar Link</button></td>
                  </tr>
                  </tbody>
                </Table>
              </Card.Body>
